...
environment_variables: Dict[str, Callable[[], Any]] = {
    ...
    # If set, use the BatchLLM as the backend fot faster inference with shared-prefix requests.
    # See https://arxiv.org/abs/2412.03594 for more details.
    "VLLM_USE_BATCHLLM":
    lambda: bool(int(os.getenv("VLLM_USE_BATCHLLM", "0"))),

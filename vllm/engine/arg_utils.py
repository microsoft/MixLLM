...
class EngineArgs:
    ...
    enforce_fused_cs: Optional[bool] = False
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        parser.add_argument('--enforce-fused-cs',
                            action='store_true',
                            help='Enable fused kernel in context_sharing if True, ')
        ...
        parser.add_argument('--num-scheduler-steps',
                            ...
                            help=('Maximum number of forward steps per '
                                  'scheduler call.'))
        parser.add_argument('--token-batching-degree',
                            type=int,
                            default=0,
                            help=('The maximum additional prefill request count '
                                  '(temporarily overriding the `max_num_seqs` limit) '
                                  'under chunked-prefill scenarios.'))
    ...
    def create_model_config(self) -> ModelConfig:
        return ModelConfig(
            ...
            enforce_fused_cs=self.enforce_fused_cs,
        )
    ...
    def create_engine_config(self) -> VllmConfig:
        ...
        if self.enable_ahead_of_prefix_clustering :
            ...
            if use_sliding_window:
                logger.error("--enable-ahead-of-prefix-clustering is currently " 
        ...
        if self.num_scheduler_steps > 1:
            ...
            if self.enable_ahead_of_prefix_clustering:
                raise ValueError("Batchllm cannot support num_scheduler_steps > 1")
        ...
        scheduler_config = SchedulerConfig(
            ...
            token_batching_degree=self.token_batching_degree,
            policy=self.scheduling_policy,
            enable_ahead_of_prefix_clustering=self.enable_ahead_of_prefix_clustering,
            )

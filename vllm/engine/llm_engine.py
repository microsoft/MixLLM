...
class LLMEngine:
    ...
    def _add_processed_request(
        ...
        min_cost_scheduler.add_seq_group(seq_group, is_batchllm_prefix)
    ...
    def _process_model_outputs(self,
        ...
        for i in indices:
            ...
            if self.model_config.task == "embedding":
                ...
                if self.scheduler[0].csgroup_manager.is_csgroup_common(seq_group) and seq_group.get_num_uncomputed_tokens() == 0:
                    for seq in seq_group.get_seqs():
        ...
        for i in finished_now:
            ...
            # NOTE(batchllm): all requests of "common" parts in `batchllm` should not
            # be taken as a request with output tokens. 
            # FIXME: a better api to check `common` or not.
            if not self.scheduler[0].csgroup_manager.is_csgroup_common(seq_group):

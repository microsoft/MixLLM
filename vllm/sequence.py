...
class SequenceStatus(enum.IntEnum):
    ...
    def get_finished_reason(status: "SequenceStatus") -> Union[str, None]:
        if status == SequenceStatus.FINISHED_STOPPED:
            ...
            # NOTE(fanghaozhou, xinji1): context_sharing setting, when the
            # common part done.
...
class SequenceGroup:
    ...
    def __init__(
        ...
        self.csgroup_common_request_id = request_id
    ...
    def update_csgroup_common_request_id(self, csgroup_common_request_id: int):
...
class SequenceGroupMetadata(
    ...
    csgroup_common_length: Optional[int] = None
    pooling_params: Optional[PoolingParams] = None
    lora_request: Optional[LoRARequest] = None
    computed_block_nums: Optional[List[int]] = None
    state: Optional[SequenceGroupState] = msgspec.field(

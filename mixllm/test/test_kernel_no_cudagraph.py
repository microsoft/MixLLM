...
import torch
import mixllm
# TODO: review if it is good
#from mixllm.nn.modules.ops import LinearMixLLM
...
if __name__ == "__main__":
    ...
    ##############################
    # TODO: review if it is good
    # = mixllm.nn.modules.linear.LinearMixLLM()
    ...
    c_mixllm = mixllm.nn.modules.ops.mixllm_gemm(
        ...
        matrix_indices_int4,
        matrix_B_int8,
        matrix_B_interleaved)
    _, latency = time_logger(
        mixllm.nn.modules.ops.mixllm_gemm,
        # TODO: review if it is good
        #                c_mixllm,
        matrix_A,
        matrix_scale_act,
